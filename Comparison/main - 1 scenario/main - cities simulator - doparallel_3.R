...
# [1.b] Parameters in cities simulator [nSim = 300]
{
  ...
  source("Data Simulator/cities simulator/scenarios/trt_modest_scen_B.R")             # cities simulator: large  trt effect,  scenario B
...
# write out
write.csv(result_df_PS,"Comparison/JSM2024/outputs/s3_PS.csv")
write.csv(result_df_BS,"Comparison/JSM2024/outputs/s3_BS.csv")
write.csv(result_df_AD,"Comparison/JSM2024/outputs/s3_AD.csv")
write.csv(tb_1B,"Comparison/JSM2024/outputs/s3_tb.csv")
# write in
