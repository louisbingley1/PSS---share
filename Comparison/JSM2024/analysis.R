...
bias_matrix = cbind.data.frame(stratum_01,stratum_10,stratum_00,stratum_11,stratum_s0)
rownames(bias_matrix)<-c("Bayesian ITT","Bayesian Delta","AdACE methodA","AdACE methodB", "PS Non-Cov-Adj","PS Cov-Adj")
...
cover_prob_matrix          = cbind.data.frame(stratum_01,stratum_10,stratum_00,stratum_11,stratum_s0)
rownames(cover_prob_matrix)= c("Bayesian ITT","Bayesian Delta","AdACE methodA","AdACE methodB", "PS Non-Cov-Adj","PS Cov-Adj")
cover_prob_matrix          = round(cover_prob_matrix,3)
cover_prob_matrix
}
...
#########################
{
  ...
  stratum_11 = c(X1,X2,X3,X4,X5,X6)
  stratum_s0 = c(AA1,AA2,AA3,AA4,AA5,AA6)
  power_matrix          = cbind.data.frame(stratum_01,stratum_10,stratum_00,stratum_11,stratum_s0)
  rownames(power_matrix)= c("Bayesian ITT","Bayesian Delta","AdACE methodA","AdACE methodB", "PS Non-Cov-Adj","PS Cov-Adj")
  power_matrix          = round(power_matrix,3)
  power_matrix
}