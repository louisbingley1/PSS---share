...
# [1.b] Parameters in cities simulator [nSim = 300]
{
  ...
  source("Comparison/JSM2024/scenarios/s8.R")             # cities simulator: large  trt effect,  scenario B
...
# write out
write.csv(result_df_PS,"Comparison/JSM2024/outputs/s8_PS.csv")
write.csv(result_df_BS,"Comparison/JSM2024/outputs/s8_BS.csv")
write.csv(result_df_AD,"Comparison/JSM2024/outputs/s8_AD.csv")
write.csv(tb_1B,"Comparison/JSM2024/outputs/s8_tb.csv")
# write in
