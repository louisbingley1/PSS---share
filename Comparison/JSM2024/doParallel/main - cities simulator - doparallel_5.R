...
# write out
write.csv(result_df_PS,"Comparison/JSM2024/outputs/s5_PS.csv")
write.csv(result_df_BS,"Comparison/JSM2024/outputs/s5_BS.csv")
write.csv(result_df_AD,"Comparison/JSM2024/outputs/s5_AD.csv")
write.csv(tb_1B,"Comparison/JSM2024/outputs/s5_tb.csv")
# write in
