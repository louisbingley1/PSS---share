...
# [1.b] Parameters in cities simulator [nSim = 300]
{
  ...
  source("Data Simulator/cities simulator/scenarios/FL1C.R")             # cities simulator: large  trt effect,  scenario B
...
# write out
write.csv(result_df_BS,"Comparison/JSM2024/analysis_re/outputs/s2_BS_re.csv")
# write in
s2_BS_re = read.csv("Comparison/JSM2024/analysis_re/outputs/s2_BS_re.csv",header=T)
