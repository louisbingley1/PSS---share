...
# write out
write.csv(result_df_BS,"Comparison/JSM2024/analysis_re/outputs/s7_BS_re.csv")
# write in
s7_BS_re = read.csv("Comparison/JSM2024/analysis_re/outputs/s7_BS_re.csv",header=T)
