...

{
  ...
  source('Magnusson/endpoint - ctn/main/f_ace_1sim_re.R')                              # Function to compute ACE within 1 dataset
...
{
  nSim  = 300 #300                                                                    # number of simulated trials
  n_patient_ctrl = 200
  n_patient_expt = 200
...
# write out
write.csv(result_df_BS,"Comparison/JSM2024/analysis_re/outputs/s1_BS_re.csv")
# write in
s1_BS_re = read.csv("Comparison/JSM2024/analysis_re/outputs/s1_BS_re.csv",header=T)
