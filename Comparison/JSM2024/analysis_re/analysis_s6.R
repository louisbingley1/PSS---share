...
s6_BS = read.csv("Comparison/JSM2024/analysis_re/outputs/s6_BS_re.csv",header=T)
...
#########################
{
  ...
  # 01/H
  N1 = f_bias(true_v = s6_BS$trued_H_01, est_v = s6_BS$ITT_H  )
  N2 = f_bias(true_v = s6_BS$trued_H_01, est_v = s6_BS$delta_H )
  
  # 10/B
  Q1 = f_bias(true_v = s6_BS$trued_B_10, est_v = s6_BS$ITT_B)
  Q2 = f_bias(true_v = s6_BS$trued_B_10, est_v = s6_BS$delta_B )
  
  # 00/I
  T1 = f_bias(true_v = s6_BS$trued_I_00, est_v = s6_BS$ITT_I)
  T2 = f_bias(true_v = s6_BS$trued_I_00, est_v = s6_BS$delta_I )
  
  # 11/D
  W1 = f_bias(true_v = s6_BS$trued_D_11, est_v = s6_BS$ITT_D)
  W2 = f_bias(true_v = s6_BS$trued_D_11, est_v = s6_BS$delta_D )
  
  #  *0/IB
  Z1 = f_bias(true_v = s6_BS$trued_IB_sp, est_v =s6_BS$ITT_IB)
  Z2 = f_bias(true_v = s6_BS$trued_IB_sp, est_v =s6_BS$delta_IB)
  ...
  # 00/++
  T3 = f_bias(true_v =  s6_AD$trued_00, est_v = s6_AD$adace_mean_plusplusA)
  T4 = f_bias(true_v =  s6_AD$trued_00, est_v = s6_AD$adace_mean_plusplusB)
  
  # *0/*+
  Z3 = f_bias(true_v =  s6_AD$trued_sp, est_v = s6_AD$adace_mean_starplusA)
  Z4 = f_bias(true_v =  s6_AD$trued_sp, est_v = s6_AD$adace_mean_starplusB)
  ...
  # 01/N
  N5 = f_bias(true_v = s6_PS$trued_N_01, est_v = s6_PS$NACE )
  N6 = f_bias(true_v = s6_PS$trued_N_01, est_v = s6_PS$NACE.adj )
  
  # 10/A
  Q5 = f_bias(true_v = s6_PS$trued_A_10, est_v = s6_PS$AACE)
  Q6 = f_bias(true_v = s6_PS$trued_A_10, est_v = s6_PS$AACE.adj )
  
  # 00/C
  T5 = f_bias(true_v = s6_PS$trued_C_00, est_v = s6_PS$CACE )
  T6 = f_bias(true_v = s6_PS$trued_C_00, est_v = s6_PS$CACE.adj )
  
  # *0/AC
  Z5 = f_bias(true_v = s6_PS$trued_AC_sp, est_v = s6_PS$CAACE)
  Z6 = f_bias(true_v = s6_PS$trued_AC_sp, est_v = s6_PS$CAACE.adj)
  ...
  s6_bias_matrix = cbind.data.frame(stratum_01,stratum_10,stratum_00,stratum_11,stratum_s0)
  rownames(s6_bias_matrix)<-c("Bayesian ITT","Bayesian Delta","AdACE methodA","AdACE methodB", "PS Non-Cov-Adj","PS Cov-Adj")
  s6_bias_matrix = round(s6_bias_matrix,3)
  s6_bias_matrix
  # write.csv(s6_bias_matrix,"Comparison/JSM2024/outputs/s6_bias_matrix.csv")
}
...
#########################
{
  ...
  # 01/H
  O1 = f_cover_prob(true_v = s6_BS$trued_H_01, l_v =s6_BS$ITT_lb_H , u_v = s6_BS$ITT_ub_H )
  O2 = f_cover_prob(true_v = s6_BS$trued_H_01, l_v =s6_BS$delta_lb_H , u_v = s6_BS$delta_ub_H )
  
  # 10/B
  R1 = f_cover_prob(true_v = s6_BS$trued_B_10, l_v = s6_BS$ITT_lb_B , u_v = s6_BS$ITT_ub_B )
  R2 = f_cover_prob(true_v = s6_BS$trued_B_10, l_v = s6_BS$delta_lb_B, u_v = s6_BS$delta_ub_B )
  
  # 00/I
  U1 = f_cover_prob(true_v = s6_BS$trued_I_00, l_v = s6_BS$ITT_lb_I , u_v = s6_BS$ITT_ub_I )
  U2 = f_cover_prob(true_v = s6_BS$trued_I_00, l_v = s6_BS$delta_lb_I, u_v = s6_BS$delta_ub_I  )
  
  # 11/D
  X1 = f_cover_prob(true_v = s6_BS$trued_D_11, l_v = s6_BS$ITT_lb_D , u_v = s6_BS$ITT_ub_D  )
  X2 = f_cover_prob(true_v = s6_BS$trued_D_11, l_v = s6_BS$delta_lb_D, u_v = s6_BS$delta_ub_D )
  
  #  *0/IB
  AA1 = f_cover_prob(true_v = s6_BS$trued_IB_sp, l_v = s6_BS$ITT_lb_IB, u_v =s6_BS$ITT_ub_IB  )
  AA2 = f_cover_prob(true_v = s6_BS$trued_IB_sp, l_v = s6_BS$delta_lb_IB, u_v = s6_BS$delta_ub_IB  )
  ...
  s6_AD$lb_ppA = s6_AD$adace_mean_plusplusA - 1.96 * s6_AD$adace_se_plusplusA
  s6_AD$ub_ppA = s6_AD$adace_mean_plusplusA + 1.96 * s6_AD$adace_se_plusplusA
  s6_AD$lb_ppB = s6_AD$adace_mean_plusplusB - 1.96 * s6_AD$adace_se_plusplusB
  s6_AD$ub_ppB = s6_AD$adace_mean_plusplusB + 1.96 * s6_AD$adace_se_plusplusB
  
  s6_AD$lb_spA = s6_AD$adace_mean_starplusA - 1.96 * s6_AD$adace_se_starplusA
  s6_AD$ub_spA = s6_AD$adace_mean_starplusA + 1.96 * s6_AD$adace_se_starplusA
  s6_AD$lb_spB = s6_AD$adace_mean_starplusB - 1.96 * s6_AD$adace_se_starplusB
  s6_AD$ub_spB = s6_AD$adace_mean_starplusB + 1.96 * s6_AD$adace_se_starplusB
  
  # 00/++
  U3 = f_cover_prob(true_v =  s6_AD$trued_00, l_v = s6_AD$lb_ppA, u_v =s6_AD$ub_ppA  )
  U4 = f_cover_prob(true_v =  s6_AD$trued_00, l_v = s6_AD$lb_ppB, u_v =s6_AD$ub_ppB )
  
  # *0/*+
  AA3 = f_cover_prob(true_v =  s6_AD$trued_sp, l_v = s6_AD$lb_spA, u_v = s6_AD$ub_spA )
  AA4 = f_cover_prob(true_v =  s6_AD$trued_sp, l_v = s6_AD$lb_spB, u_v = s6_AD$ub_spB   )
  ...
  # 01/N
  O5 = f_cover_prob(true_v = s6_PS$trued_N_01, l_v = s6_PS$NACE_bs_CI_l, u_v = s6_PS$NACE_bs_CI_u  )
  O6 = f_cover_prob(true_v = s6_PS$trued_N_01, l_v = s6_PS$NACE.adj_CI_l, u_v =s6_PS$NACE.adj_CI_u  )
  
  # 10/A
  R5 = f_cover_prob(true_v = s6_PS$trued_A_10, l_v =  s6_PS$AACE_CI_l, u_v = s6_PS$AACE_CI_u   )
  R6 = f_cover_prob(true_v = s6_PS$trued_A_10, l_v =  s6_PS$AACE.adj_CI_l, u_v =s6_PS$AACE.adj_CI_u  )
  
  # 00/C
  U5 = f_cover_prob(true_v = s6_PS$trued_C_00, l_v = s6_PS$CACE_CI_l, u_v = s6_PS$CACE_CI_u  )
  U6 = f_cover_prob(true_v = s6_PS$trued_C_00, l_v = s6_PS$CACE.adj_CI_l, u_v =s6_PS$CACE.adj_CI_u  )
  
  # *0/AC
  AA5 = f_cover_prob(true_v = s6_PS$trued_AC_sp, l_v = s6_PS$CAACE_CI_l, u_v =s6_PS$CAACE_CI_u  )
  AA6 = f_cover_prob(true_v = s6_PS$trued_AC_sp, l_v = s6_PS$CAACE.adj_CI_l, u_v =s6_PS$CAACE.adj_CI_u  )
  ...
  s6_cover_prob_matrix          = cbind.data.frame(stratum_01,stratum_10,stratum_00,stratum_11,stratum_s0)
  rownames(s6_cover_prob_matrix)= c("Bayesian ITT","Bayesian Delta","AdACE methodA","AdACE methodB", "PS Non-Cov-Adj","PS Cov-Adj")
  s6_cover_prob_matrix          = round(s6_cover_prob_matrix,3)
  s6_cover_prob_matrix
  # write.csv(s6_cover_prob_matrix,"Comparison/JSM2024/outputs/s6_cover_prob_matrix.csv")
}
...
#########################
{
  ...
  # 01/H
  O1 = f_power(true_v = s6_BS$trued_H_01, l_v =s6_BS$ITT_lb_H , u_v = s6_BS$ITT_ub_H )
  O2 = f_power(true_v = s6_BS$trued_H_01, l_v =s6_BS$delta_lb_H , u_v = s6_BS$delta_ub_H )
  
  # 10/B
  R1 = f_power(true_v = s6_BS$trued_B_10, l_v = s6_BS$ITT_lb_B , u_v = s6_BS$ITT_ub_B )
  R2 = f_power(true_v = s6_BS$trued_B_10, l_v = s6_BS$delta_lb_B, u_v = s6_BS$delta_ub_B )
  
  # 00/I
  U1 = f_power(true_v = s6_BS$trued_I_00, l_v = s6_BS$ITT_lb_I , u_v = s6_BS$ITT_ub_I )
  U2 = f_power(true_v = s6_BS$trued_I_00, l_v = s6_BS$delta_lb_I, u_v = s6_BS$delta_ub_I  )
  
  # 11/D
  X1 = f_power(true_v = s6_BS$trued_D_11, l_v = s6_BS$ITT_lb_D , u_v = s6_BS$ITT_ub_D  )
  X2 = f_power(true_v = s6_BS$trued_D_11, l_v = s6_BS$delta_lb_D, u_v = s6_BS$delta_ub_D )
  
  #  *0/IB
  AA1 = f_power(true_v = s6_BS$trued_IB_sp, l_v = s6_BS$ITT_lb_IB, u_v =s6_BS$ITT_ub_IB  )
  AA2 = f_power(true_v = s6_BS$trued_IB_sp, l_v = s6_BS$delta_lb_IB, u_v = s6_BS$delta_ub_IB  )
  ...
  # 00/++
  U3 = f_power(true_v =  s6_AD$trued_00, l_v = s6_AD$lb_ppA, u_v =s6_AD$ub_ppA  )
  U4 = f_power(true_v =  s6_AD$trued_00, l_v = s6_AD$lb_ppB, u_v =s6_AD$ub_ppB )
  
  # *0/*+
  AA3 = f_power(true_v =  s6_AD$trued_sp, l_v = s6_AD$lb_spA, u_v = s6_AD$ub_spA )
  AA4 = f_power(true_v =  s6_AD$trued_sp, l_v = s6_AD$lb_spB, u_v = s6_AD$ub_spB   )
  ...
  # 01/N
  O5 = f_power(true_v = s6_PS$trued_N_01, l_v = s6_PS$NACE_bs_CI_l, u_v = s6_PS$NACE_bs_CI_u  )
  O6 = f_power(true_v = s6_PS$trued_N_01, l_v = s6_PS$NACE.adj_CI_l, u_v =s6_PS$NACE.adj_CI_u  )
  
  # 10/A
  R5 = f_power(true_v = s6_PS$trued_A_10, l_v =  s6_PS$AACE_CI_l, u_v = s6_PS$AACE_CI_u   )
  R6 = f_power(true_v = s6_PS$trued_A_10, l_v =  s6_PS$AACE.adj_CI_l, u_v =s6_PS$AACE.adj_CI_u  )
  
  # 00/C
  U5 = f_power(true_v = s6_PS$trued_C_00, l_v = s6_PS$CACE_CI_l, u_v = s6_PS$CACE_CI_u  )
  U6 = f_power(true_v = s6_PS$trued_C_00, l_v = s6_PS$CACE.adj_CI_l, u_v =s6_PS$CACE.adj_CI_u  )
  
  # *0/AC
  AA5 = f_power(true_v = s6_PS$trued_AC_sp, l_v = s6_PS$CAACE_CI_l, u_v =s6_PS$CAACE_CI_u  )
  AA6 = f_power(true_v = s6_PS$trued_AC_sp, l_v = s6_PS$CAACE.adj_CI_l, u_v =s6_PS$CAACE.adj_CI_u  )
  ...
  stratum_11 = c(X1,X2,X3,X4,X5,X6)
  stratum_s0 = c(AA1,AA2,AA3,AA4,AA5,AA6)
  s6_power_matrix          = cbind.data.frame(stratum_01,stratum_10,stratum_00,stratum_11,stratum_s0)
  rownames(s6_power_matrix)= c("Bayesian ITT","Bayesian Delta","AdACE methodA","AdACE methodB", "PS Non-Cov-Adj","PS Cov-Adj")
