...
f_augdata_vali = function(data,Z,D,X,beta.a_old,beta.n_old,USUBJID){   
  ...
  colnames(AugData)<-c("PS","one","X_1","X_2","X_3","X_4","X_5","w_iter","USUBJID","Uhat","indexZU")
  ...
  AugData$X_3    = as.numeric(AugData$X_3)
  AugData$X_4    = as.numeric(AugData$X_4)
  AugData$X_5    = as.numeric(AugData$X_5)
